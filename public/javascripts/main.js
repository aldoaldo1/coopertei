...
//  LISTADO OT
    e.define("/models/Purchase.js", function(e, t, n, r, i, s) {
        C.Model.Purchase = Backbone.Model.extend({
            urlRoot: "/purchase",
            defaults: function() {
                return {
                    firstname: null,
        ...
        }), C.Collection.Purchase = Backbone.Collection.extend({
            model: C.Model.Purchase,
            url: "/person",
            initialize: function(e, t) {
            }
        });
...
//  /Listado Ot
    e.define("/models/Plan.js", function(e, t, n, r, i, s) {
                    ...
                    n = $("<input>", {
                        ...
                        (!((C.Session.getUser().area_id == 3) || (C.Session.getUser().role_id == 7 || C.Session.getUser().role_id == 5))) ? F.msgError("No tiene los permisos necesarios") : ($("body").append('<div id="material_order_received" class = "modal" style="display:none; max-height:500px; overflow: auto"><h1 class="bold" style="font-size:20px;">' + e.category + ": " + e.name + " Cant: " + e.quantity + e.unit.split(" ")[0] + '<br /><br /></h1><br /><form id="add_task_ot_form"><h2>Cantidad Recibida:<p>(sólo Números)</p><input type="text" name="quantity_received" /><br /><h2>Remito Nº:<input type="text" name="remito" /><br /><h2>Observaciones</h2> <textarea name="observation_received" style="height:100px" /></h2><br /></form><a class="BUTTON_cancel lefty">Cancelar</a><input type="button" class="BUTTON_proceed righty button" value="Aceptar" /></div>'), $("#material_order_received .BUTTON_cancel").on("click", function() {
                            ...
                            if (!isNaN($("#material_order_received input:text[name=quantity_received]").val())){
                                ...
                                F.msgOK("Materiales Recibidos Correctamente"), $.ajax({
                        ...
                        $.ajax({
                            ...
                            success: function(e) {
                                e.result === !0 ? t(function() {
                                    ...
                                    F.msgOK('Materiales cargados correctamente');
                                }) : t(function() {
        ...
        C.View.OtAdminOptions = Backbone.View.extend({
            ...
            buildDelaysList: function(e) {
                ...
                return $(t).append($("<option>", {
                    value: 0
                }).text("Seleccione razón de reprogramacion de entrega...")), _.each(e.delays, function(e) {
                    $(t).append($("<option>", {
                        value: e.id
                    }).text(e.reason));
                }), t;
        ...
        C.View.OtAuditAddTask = Backbone.View.extend({
            ...
            initialize: function() {
                ...
                $(document).on('click', '#add_task_ot_form input[name="reprogram"]', function(){
                    var c = this;
                        if ($(c).is(':checked')){
        ...
        C.View.OtAuditToggleTaskState = Backbone.View.extend({
            ...
            template: function() {
                $("body").append('<div id="ot_toggle_task_state_window" class="modal" style="display:none; overflow: auto; height:600px;"><h1 class="bold">Liste los empleados que trabajaron y horarios invertidos en esta tarea:</h1><br /><br /><form id="toggle_task_state_ot_form"><div></div></form><br /><br /><input type="button" class="BUTTON_cancel lefty button" value="Cancelar" /><input type="button" class="BUTTON_proceed righty button" value="Completar Tarea" /><input type="button" class="BUTTON_proceed_job righty button" value="Continuar Trabajando" /></div>');
            ...
            performToggleState: function() {
                this.options.performToggleTaskState(this.cleanModals), this.cleanModals()
            },
            ...
            cancelToggleState: function() {
                $(this.options.checkbox).attr("checked", !1);
                this.cleanModals();
            }
        });
        ...
        C.View.OtAuditOptions = Backbone.View.extend({
            ...
            renderForm: function() {
                var e = this;
                $("#ot_rework_task_window").length || (this.templateForm(), $("#ot_rework_task_window .BUTTON_cancel").on("click", function() {
                    e.cancelAddTask();
                }), $("#ot_rework_task_window .BUTTON_proceed").on("click", function() {
                    e.performAddTask();
                })), $.blockUI({
                    message: $("#ot_rework_task_window"),
                    css: {
                        top: "15%",
                        left: "30%",
                        width: "38%",
            ...
            templateForm: function() {    
                var e = this;
                var r = $(".ot_table").dataTable(), i = F.getDataTableSelection($(".ot_table"))[0], s = 0, o = parseInt(r.fnGetData(i).id);
                $("body").append('<div id="ot_rework_task_window" class="reworkTask modal" style="display:none;"><h1 class="bold">Ingrese los datos de la tarea a retrabajar:</h1><br /><br /><form id="rework_task_ot_form"></form><br /><br /><a class="BUTTON_cancel lefty">Cancelar</a><input type="button" class="BUTTON_proceed righty button" value="Retrabajar Tarea" /></div>'), $(".button").button();
                $('#rework_task_ot_form').append('<input type="text" placeholder="Tiempo estimado (Dias)" value="'+task.eta+'" name="eta" style="width:200px;display:inline"><input type="checkbox" name="reprogramTask"><label for="reprogramTask" style="display:inline">Reprogramar Tareas</label> <input type="checkbox" disabled="disabled" name="reprogram"><label style="display:inline" disabled="disabled" for="reprogramOT">Reprogramar OT</label>');
                task.reprogram = 'false';
                task.reprogramTask = 'false';
                $(document).on('click', 'input[name="reprogramTask"]', function(){
                    var rt = this
                    if($(rt).is(':checked')){
                        task.reprogramTask = 'true';
                        $('input[name="reprogram"]').attr('disabled', !1)
                    }
                    else{
                        task.reprogramTask = 'false';
                ...
                $(document).on('click', '#rework_task_ot_form input[name="reprogram"]', function(){
                    var c = this;
                        if ($(c).is(':checked')){
                            task.reprogram = 'true';
                            $('#rework_task_ot_form').append('<div class="explaination"><textarea placeholder="Observación" name="observation"></textarea></div>')
                            if ($('.explaination').length > 1){
                                $('.explaination:last').remove()
                            }else{
                                e.getDelays('delays');
                                if ($('.delay_id').length > 1){
                                    $('.delay_id:first').remove()
                ...
                $(document).one('click', '.BUTTON_proceed', function(){
                    i = this;
                    task.eta = $('#rework_task_ot_form input[name="eta"]').val()
                    ...
                    if($('input[name="reprogram"]').is(':checked')){
                        if (task.delay_id != 0){
                            ...
                            F.msgError('Elija una razón de reprogramacion de entrega');
                        }
                    }else{
                        $.ajax({
                            url: "/ottask/rework/" + task.id + "/after/" + task.position,
            ...
            buildDelaysList: function(e) {
                ...
                $('.explaination').append(t), $(t).append($("<option>", {
                    value: 0
                }).text("Seleccione razón de reprogramacion de entrega...")), _.each(e, function(e) {
                    $(t).append($("<option>", {
                        value: e.id
                    }).text(e.reason));
                }), t;
        ...
        C.View.OtAuditTable = Backbone.View.extend({
            ...
            renderOtTaskResources: function(e, t) {
                C.Session.roleID() >= 2 && new C.View.OtTaskResources({
                    task_row: e,
                    task: t
                });
            },
    ...
    e.define("/views/material/Purchase.js", function(e, t, n, r, i, s) {
        C.View.Purchase = Backbone.View.extend({
            ...
            initialize: function() {
                var e = this;
                this.purchases = new C.Collection.Purchase(null, {
                    view: this
        ...
        C.View.PurchaseTable = Backbone.View.extend({
            ...
            events: {
                "click .purchase_table tr": "selectRow"
            },
            selectRow: function(e) {
                this.selected_row = $(e.currentTarget);
            }
        ...
        C.View.PurchaseForm = Backbone.View.extend({
            ...
            editDate: function() {
                ...
                var e = this;
                if (C.Session.getUser().area_id == 8 || C.Session.getUser().role_id == 5){
    ...
    e.define("/views/personnel/Employee.js", function(e, t, n, r, i, s) {
        ...
        C.View.InoutTable = Backbone.View.extend({
            ...
            //date_columns: ['authorized', 'out', 'comeback'],
            data: null,
            rowHandler: function(e, t) {
                function n(n, r, i) {
    ...
    e.define("/views/profile/Profile.js", function(e, t, n, r, i, s) {
    ...
    }), e.define("/views/report/Query.js", function(e, t, n, r, i, s) {
    ...
    }), e.define("/views/report/QueryTable.js", function(e, t, n, r, i, s) {
    ...
    }), e.define("/views/report/QueryForm.js", function(e, t, n, r, i, s) {
    ...
    }), e.define("/views/report/QueryPredefinedList.js", function(e, t, n, r, i, s) {
        C.View.QueryPredefinedList = Backbone.View.extend({
            ...
            events: {
                "click #report_right .graphEmployeeProducivity": "getEmployeeTasksAndGraphThem"
            },
            getEmployeeTasksAndGraphThem: function() {
                var e = this;
                $("#query_chart").remove(), $("#report_left").append('<div id="query_chart"><svg></svg></div>'), $("#report_left").css({
                    height: "500px"
                }), $("#query_chart").css({
                    height: parseInt($("#report_left").css("height")) + "px",
                    minWidth: "100px",
                    minHeight: "100px"
                }), $.ajax({
                    type: "POST",
        ...
        C.View.OtStateTable = Backbone.View.extend({
            ...
            date_columns: ["reception", "delivery"],
            data: null,
            initialize: function() {
                t = this;
                F.createDataTable(this, function(e) {
        ...
        C.View.OtDeliveryForm = Backbone.View.extend({
            ...
            filter: function(){
                if ($('.otdelivery_form').serializeObject().start != '' && $('.otdelivery_form').serializeObject().end != ''){
    ...
    }), e.define("/views/report/OtDeadline.js", function(e, t, n, r, i, s) {
        C.View.OtDeadline = Backbone.View.extend({
            el: $("body"),
            initialize: function() {
                var e = this;
                e.otdeadline_table = new C.View.OtDeadlineTable({
                    el: $("#otdeadline_left"),
                }), e.otdeadline_form = new C.View.OtDeadlineForm({
                    el: $("#report_right"),
                    model: {},
                    otdeadline_table: e.otdeadline_table
                });
            }
        });
    }), e.define("/views/report/OtDeadlineTable.js", function(e, t, n, r, i, s) {
        C.View.OtDeadlineTable = Backbone.View.extend({
            name: "otdeadline",
            source: "",
            headers: [ "ID", "Numero", "Equipo(TAG)", "Cliente", "Intervención", "Plan", "Retrabajo de", "Estado", "Recepción", "Entrega" ],
            attrs: [ "id", "number", "equipment", "client", "intervention", "plan", "reworked", "otstate", "reception", "delivery"],
    ...
    }), e.define("/views/report/OtDeadlineForm.js", function(e, t, n, r, i, s) {
        C.View.OtDeadlineForm = Backbone.View.extend({
            name: "otdeadline_form",
            title: "Rango de fechas",
            fields: {
                start: {
                    label: 'Desde',
            ...
            initialize: function() {
                ...
                console.log(e)
                F.createForm(e);
                $('.otdeadline_form').append('<input type="button" class="BUTTON_proceed" value="Filtrar">')
            },
            events: {
                "click .BUTTON_proceed" : 'filter',
            },
            filter: function(){
                if ($('.otdeadline_form').serializeObject().start != '' && $('.otdeadline_form').serializeObject().end != ''){
                    var start = $('.otdeadline_form').serializeObject().start.split('/');
                    var end = $('.otdeadline_form').serializeObject().end.split('/');
                    start = start[2]+'-'+start[1]+'-'+start[0];
                    end = end[2]+'-'+end[1]+'-'+end[0];
                    
                    console.log('/otdeadlinereport/'+start+'/'+end);
                    F.redirectDataTable('.otdeadline_table', '/otdeadlinereport/'+start+'/'+end)
                }else{
                    F.msgError('Complete los campos faltantes');
                }
    ...
    }), e.define("/views/report/OtConclude.js", function(e, t, n, r, i, s) {
        C.View.OtConclude = Backbone.View.extend({
            el: $("body"),
            initialize: function() {
                var e = this;
                e.otconclude_table = new C.View.OtConcludeTable({
                    el: $("#otconclude_left"),
                }), e.otconclude_form = new C.View.OtConcludeForm({
                    el: $("#report_right"),
                    model: {},
                    otconclude_table: e.otconclude_table
                });
            }
        });
    }), e.define("/views/report/OtConcludeTable.js", function(e, t, n, r, i, s) {
        C.View.OtConcludeTable = Backbone.View.extend({
            name: "otconclude",
            source: "",
            headers: [ "ID", "Numero", "Equipo(TAG)", "Cliente", "Intervención", "Plan", "Retrabajo de", "Estado", "Recepción", "Entrega" ],
            attrs: [ "id", "number", "equipment", "client", "intervention", "plan", "reworked", "otstate", "reception", "delivery"],
            ...
            data: null,
            datatableOptions: {
                aaSorting: [ [ 1, "desc" ], [3, "desc"], [2, "desc"] ]
            },initialize: function() {
                t = this;
                F.createDataTable(this)
                /*$(document).on('click', '.person_table tbody tr', function(evento){
    ...
    }), e.define("/views/report/OtConcludeForm.js", function(e, t, n, r, i, s) {
        C.View.OtConcludeForm = Backbone.View.extend({
            name: "otconclude_form",
            title: "Rango de fechas",
            fields: {
                start: {
                    label: 'Desde',
            ...
            initialize: function() {
                ...
                F.getAllFromModel('client', function(t){
                    e.relations.clients = t.data, F.getAllFromModel("equipment", function(t){
                        e.relations.equipments = t.data, F.createForm(e);
                        $('.otconclude_form').append('<input type="button" class="BUTTON_proceed" value="Filtrar">')
                    })
                })
            },
            events: {
            ...
            filter: function(){
                if ($('.otconclude_form').serializeObject().start != '' && $('.otconclude_form').serializeObject().end != ''){
                    var start = $('.otconclude_form').serializeObject().start.split('/');
                    var end = $('.otconclude_form').serializeObject().end.split('/');
                    start = start[2]+'-'+start[1]+'-'+start[0];
                    end = end[2]+'-'+end[1]+'-'+end[0];
                    var client = $('.otconclude_form').serializeObject().client_id;
                    var tag = $('.otconclude_form').serializeObject().equipment_id;
                    var rework = $('.otconclude_form').serializeObject().rework;
                    if (rework == ''){
                        rework = 0;
                    }if (client == ''){
                        client = 0;
                    ...
                    console.log('/otconcludereport/'+start+'/'+end);
                    F.redirectDataTable('.otconclude_table', '/otconcludereport/'+start+'/'+end+'/'+client+'/'+tag+'/'+rework)
                }else{
                    F.msgError('Complete los campos faltantes');
                }
        ...
        $(function() {
            var e = Backbone.Router.extend({
                ...
                getQuery: function() {
                    var e = function() {
                        document.title = C.TITLE + "Consultas", this.report_widget = C.Widget.Report.initialize(), this.query_view = new C.View.Query({
                            model: new C.Model.Query
                        }), F.R.highlightCurrentModule("report/queries");
                    }.bind(this);
                    C.Session.doIfInRolesList([ 4, 5 ], e);
                },
                ...
                getOtDeadlineReport: function(){
                    var e = function() {
                        document.title = C.TITLE + "Vencimientos", this.otreport_widget = C.Widget.Report.initialize(), this.otdeadlinereport_view = new C.View.OtDeadline({
                        }), F.R.highlightCurrentModule("reports/otdeadline");
                    }.bind(this);
                    C.Session.doIfInRolesList([ 2, 4, 5, 7, 8 ], e);   
                },
                getOtConcludeReport: function(){
                    var e = function() {
                        document.title = C.TITLE + "Vencimientos", this.otreport_widget = C.Widget.Report.initialize(), this.otconcludereport_view = new C.View.OtConclude({
                        }), F.R.highlightCurrentModule("reports/otconclude");
                    }.bind(this);
                    C.Session.doIfInRolesList([ 2, 4, 5, 7, 8 ], e);   
                },
